#pragma checksum "F:\四川师范大学实验室安全考试项目\lab\project\LabExam\LabExam\Views\Manager\list.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "71a81caa02dc6538fc0ffcb24763e5a092963c3c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"71a81caa02dc6538fc0ffcb24763e5a092963c3c", @"/Views/Manager/list.cshtml")]
...
");
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "396f88ba5cdc48348a1bbd4f73afe1ed", async() => {
...
<div class="" bc-clr-white margin-5px  padding-15px border-little-grey-all"" data-min-width=""1250"">
    ...
    <div class="" float-layout "">
        ...
        <div class="" float-right"">
            <a href=""#"" class="" btn-defau");
            WriteLiteral(@"lt btn btn-sm "">
                <span>第</span>
            ...
            <button class=""Last btn btn-primary btn-sm"" data-lastIndex=""1"" >
                尾页 <span class=""gly");
            WriteLiteral(@"phicon glyphicon-forward""></span>
            </button>
...
<script id=""detail-template"" type=""x-tmpl-mustache"">
    <div class=""modal-content"">
        <div class=""modal-header"">
            ...
            WriteLiteral(@"Close""><span aria-hidden=""true"">&times;</span></button>
            ...
            WriteLiteral(@"               <div class=""student-info-show"">
                ...
                <div class=""student-info-show"">
                    <div class=""student-info-show-content padding-left-10px"">
                        ...
                        <span class=""student-info-show-value border-light-down ""> {{professionName}}</sp");
            WriteLiteral(@"an>
                    </div>
                </div>
                <div class=""student-info-show"">
                ...
                <div class=""student-info-show"">
                    <div class=""student-info-show-content padding-left-10px"">
                        ...
                        <span class=""stud");
            WriteLiteral(@"ent-info-show-value border-light-down ""> {{loginCount}} [次]</span>
                    </div>
                </div>
                <div class=""student-info-show"">
                    <div class=""student-info-show-content padding-left-10px"">
    ...
    <script type=""text/javascript"">
     ...
     ");
        ...
        function loadPageByIndex(index) {
            $.ajax({
                ...
                WriteLiteral(@" $('.section-items').html("""");
                        ...
                        for (let index_ = 0; index_ < json.pageCount; ind");
                WriteLiteral(@"ex_++) {
        ...
        $('.Last').click(function(jqEvent) {
            loadPageByIndex($('button[data-l");
                WriteLiteral(@"astIndex]').attr(""data-lastIndex"").trim());
        });
        ...
        $('.section-items').on('click',
            ...
            function(jqEvent) {
                var i");
                WriteLiteral(@"d = $(this).attr(""data-detail-id"");
                $.ajax({

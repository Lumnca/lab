#pragma checksum "F:\四川师范大学实验室安全考试项目\lab\project\LabExam\LabExam\Views\Institute\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "647abe31de07c57507fae62d411741cdae234254"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"647abe31de07c57507fae62d411741cdae234254", @"/Views/Institute/Index.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "52d61eabd64844d0b909e18c75474e71", async() => {
            }
            );
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7da6d4176f5b4670a74be4048ba7f568", async() => {
    ...
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-footer"">
                ...
                <button type=""button"" class=""btn btn-primary""  > <span class=""glyphicon glyphicon-trash""></span> 立即删除</button>
            </div>
        </div>
 ");
            WriteLiteral(@"   </div>
...
<script id=""fuiInstituteListTemplate"" type=""x-tmpl-mustache"">
    ...
    <tr>
        ...
        <td>正常</td>
        <td class="" text-right "">
            <button data-instituteId=""{{id}}"" 
                    class="" buttonDelete btn btn-primary btn-sm"">
                <span class=""glyphicon glyphicon-remove""></span>
                删除
            </button>
            <button data-instituteId=""{{id}}""  data-name=""{{name}}""
                    class=""buttonUpdate btn btn-default btn-sm"">
                <span class=""glyphicon glyphicon-search""></span>
                修改
            </button>
...
");
 ...
 ");
            ...
            function loadPageByIndex(index) {
                ...
                ");
                WriteLiteral(@"            Mustache.parse(template);
      ...
      ");
            ...
            $('#fuiInstituteList').on(""click"",
                ...
                null,
                function(jaEvent) {
                    var insId = $(this).attr(""data-institute");
                WriteLiteral(@"Id"");
                    $('#deleteInstitute').modal('show');

                    $('#deleteInstitute button:first').attr(""data-deleteId"", insId);
                });

            $('#deleteInstitute button:first').click(function(jqEvent) {
                    ...
                    toolbox: {
                        ...
                        feature: {
                            saveAsImage: {
                                ...
                                iconStyle: {
 ");
                WriteLiteral(@"                                   shadowColor: 'rgba(0, 0, 0, 0.2)',
                                    shadowBlur: 10
                                }
                            },
